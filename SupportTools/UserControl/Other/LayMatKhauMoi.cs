...
{
    public partial class LayMatKhauMoi : DevExpress.XtraEditors.XtraUserControl
    {
        public LayMatKhauMoi()
        {
            InitializeComponent();
        }
            ...
            if(txtMSNV.Text != null)
            {
                try
                {
                    ...
                    else if (radiobtnERP.Checked == true)
                    {
                        ...
                        {
                            radiobtnERP.Text = "Không tìm thấy user này.";
                        }
                    }
